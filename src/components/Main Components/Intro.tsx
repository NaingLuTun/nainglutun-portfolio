...
const Intro = () => {
  return (
    <section id="intro" className=" bg-[#07080a] w-full h-[100vh] p-[25px] pb-0 introSection">

          <Header />

          <div className="bg-inherit p-[14px] pt-[70px] pb-[70px] text-center introTextsContainer">
