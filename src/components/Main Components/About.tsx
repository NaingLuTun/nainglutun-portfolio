            ...
            <div className="bg-[#252525] w-full  rounded-xl flex flex-col gap-4 relative lg:flex-row  aboutContainer backgroundPattern2">
                ...
                <div className="w-full lg:w-[60%] p-4 pt-8 pb-8 lg:pb-0 aboutMeInfo">
                    ...
                    <p className={`text-white text-[18px] leading-8 mb-[100px] ${isLargerScreen? "mb-[130px]":  isBigScreen? "mb-[80px]":""} aboutMePara`}>
                        Hello, I am a frontend developer from Yangon, Myanmar. I am mostly a self taught programmer but to advance my skills I also took <span className="font-[600] text-[19px]">professional frontend developer course</span> from Meta. I've been learning and builing my personal projects on my own for about a little over a year now, and I'm finally ready to make use of the skills I've gained in real-world projects, taking on new challenges in a professional setting. I'm a <span className="font-[600] text-[19px]">resourceful</span> person who gets the job done, even when ideal resources are limited, I also have a strong <span className="font-[600] text-[19px]">attention to detail</span>, ensuring accuracy and precision in my projects. While I'm naturally an introvert, I'm confident and proactive in group settings, making sure that my contributions to the team are meaningful and my ideas are heard. I'm currently looking for an <span className="font-[600] text-[19px]">intern or junior position</span> , so If you like what you see in my portfolio, I'd love to connect. Please feel free to reach out!
                    </p>
                    ...
                    <div className="grid grid-cols-2 w-full nameAndEmailContainer">
                        ...
                        <div className="flex items-center gap-1 -ml-6 lg:-ml-0 CVContainer">
                            ...
                            <a href={cvFile} download="NaingLuTunCV" className="text-white text-[18px] font-[600] flex items-center gap-1">
